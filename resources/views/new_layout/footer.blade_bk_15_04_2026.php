...
<!-- New Footer -->
<footer
    class="footer-new text-white position-relative {{ (Request::is('scholarship*') || Request::is('university*') || Request::is('universities*') || Request::is('*course*') || Request::is('*login*') || Request::is('*register*') || Request::is('*signup*')) ? 'footer-no-contact' : '' }}">
    <div class="container">
        <div class="row">
            <!-- Col 1: Brand & Social -->
            <div class="col-lg-3 mb-5 mb-lg-0">
                ...
                <div class="social-icons-footer d-flex">
                    <a href="https://www.facebook.com/share/1DBRFVmTai/" class="social-btn facebook-glossy mr-3"
                        target="_blank"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://www.instagram.com/educircle.io?igsh=MTVreGRjdWx4c3F3Mw=="
                        class="social-btn instagram-glossy mr-3" target="_blank"><i class="fab fa-instagram"></i></a>
                    <a href="https://www.linkedin.com/company/educircle-io/" class="social-btn linkedin-glossy mr-3"
                        target="_blank"><i class="fab fa-linkedin-in"></i></a>
                    <a href="https://youtube.com/@studywitheducircle?si=8bsEdTv_UrfNilxh"
                        class="social-btn youtube-glossy" target="_blank"><i class="fab fa-youtube"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 mb-5 mb-lg-0">
                ...
                <ul class="list-unstyled footer-contact-list">
                    <li class="mb-2"><a class="text-light-gray small">+918130820084</a>
                    </li>
                    <li class="mb-2"><a class="text-light-gray small">+61449554542</a></li>
                    <li><a class="text-light-gray small">admissions@educircle.io</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3">
                ...
                <ul class="list-unstyled footer-links small">
                    <li class="mb-2"><a href="{{ route('course.program') }}" class="text-light-gray">Course Finder</a>
                    </li>
