            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Create University</h4>
                            ...
                            <form action="{{ route('university.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="estd" class="form-control" placeholder="e.g., 1995"
                                            required>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="rank" class="form-control" placeholder="e.g., 12" required>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="region_type" class="form-control" required>
                                            <option value="Non-Regional" {{ old('region_type') == 'Non-Regional' ? 'selected' : '' }}>Non-Regional</option>
                                            <option value="Regional" {{ old('region_type') == 'Regional' ? 'selected' : '' }}>Regional</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="description" class="summernote form-control" rows="5">{{ old('description') }}</textarea>
                                    </div>
                                </div>
