        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Edit Scholarship</h4>
                        ...
                        <form action="{{ route('scholarship.update', $scholarship->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="university_id" class="form-control @error('university_id') is-invalid @enderror" required>
                                        <option value="">Select University</option>

                                        @foreach ($universitycourses as $uc)
                                            <option value="{{ $uc->id }}"
                                                {{ old('university_id', $scholarship->university_id) == $uc->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="course_id" class="form-control @error('course_id') is-invalid @enderror" required>
                                        ...
                                        @foreach ($universitycourses as $uc)
                                            <option value="{{ $uc->id }}"
                                                {{ old('course_id', $scholarship->course_id) == $uc->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="amount"
                                        ...
                                        value="{{ old('amount', $scholarship->amount) }}" required>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="eligibility"
                                        class="summernote @error('eligibility') is-invalid @enderror"
                                        rows="6" required>{{ old('eligibility', $scholarship->eligibility) }}</textarea>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="description"
                                        ...
                                        rows="6" required>{{ old('description', $scholarship->description) }}</textarea>
