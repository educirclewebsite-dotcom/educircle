            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Add Partner Logo</h4>
                            ...
                            <form action="{{ route('partner-logos.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        Recommended: PNG, JPG, JPEG, SVG. Max size: 2MB
                                    </small>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('display_order') is-invalid @enderror"
                                        ...
                                        value="{{ old('display_order', $nextOrder) }}" min="0" required>
                                    @error('display_order')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <small class="form-text text-muted">
                                ...
                                <div class="form-group mb-0">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ri-save-line mr-1"></i> Save Partner Logo
                                    </button>
